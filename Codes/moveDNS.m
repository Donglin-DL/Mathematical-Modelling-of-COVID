function [theta_Alg, log_prior_Alg, log_like_Alg, my_changed_theta, log_like_best_changed, par_best_changed] = moveDNS(which_action, log_like_sample, theta_level_Alg, theta_Alg, log_prior_Alg, log_like_Alg, logfuns, t, k, log_like_best, widths, n1, par_best)
%The function "moveDNS" decides whether or not to move a particle from its
